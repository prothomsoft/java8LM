...
import info.solidsoft.java8.stackoverflow.LoadFromStackOverflowTask;
...
public class J21_FuturesIntroductionTest extends AbstractFuturesTest {
	...
	@Test
	public void waitJustForFirst() throws Exception {
	...
	@Test
	public void processEveryResponseImmediatelyWhenAvailable() throws Exception {
		final Future<String> java = findQuestionsAbout("java");
		final Future<String> scala = findQuestionsAbout("scala");
